...
import csv
import os
from bert.bert_code import tokenization, optimization, modeling
...
class PaddingInputExample(object):
  ...
  utilty use this class instead of `None` because treating `None` as padding
...
def input_fn_builder(features, seq_length, is_training, drop_remainder):
  ...
  def input_fn(params):
    ...
    # This is for demo purposes and does NOT scale to large data sets. utilty do
